...
These days I build [Senpai](https://wandb.github.io/senpai/), an autonomous ML research framework (ICML 2026), and use it on CFD surrogate modeling — AirfRANS, TandemFoilSet, DrivAerML — and aerodynamics with the **Aston Martin Aramco Formula One Team**. Most of the interesting work is flow matching and diffusion models: putting high-frequency detail back into pressure and velocity fields instead of just predicting the mean.
